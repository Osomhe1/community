...
import { hrFormTableData } from "./data";
...
const columns = [
  ...
  {name: "download", uid: "download", sortable: true},
];
...
const HrFormTable = ({handleOpenDrawer, }) => {
  ...
  const filteredItems = React.useMemo(() => {
    let filteredrows = [...hrFormTableData];
    ...
    return filteredrows;
  }, [hrFormTableData, filterValue, statusFilter]);
  ...
  const renderCell = React.useCallback((user, columnKey) => {
    ...
    switch (columnKey) {
      ...
      case "download":
        return (
             <button className=" bg-[#00bcc2] hover:bg-[#59b9bd] text-white flex gap-1 items-center px-3 py-1">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex justify-between items-center">
          <span className="text-default-400 text-small">
            Total: {hrFormTableData.length} data
          </span>
