...
import TextForm from '../../medaicalForm/TextForm'
import AttachmentForm from '../../medaicalForm/AttarchmentForm'
import NoteForm from '../../medaicalForm/NoteForm'

export default function MedicalInformationDrawer({ isOpen, setIsOpen }) {
  const [selectedTab, setSelectedTab] = useState(0)

  const tabs = [
    { title: 'Details', sub: 'Fill form', content: <TextForm /> },
    {
      title: 'Attachments',
      sub: 'Upload ',
    ...
    <>
      <ExpandedDrawer isOpen={isOpen} onClose={setIsOpen}>
        ...
        <div className='bg-[#f5f7fa] min-h-screen  p-10'>
          <h4 className='header_h3 text-2xl'>Medical Information</h4>
