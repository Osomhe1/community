...
import TextForm from '../../contactForm/TextForm'
import AttachmentForm from '../../contactForm/AttarchmentForm'
import NoteForm from '../../contactForm/NoteForm'

export default function ContactInformationDrawer({ isOpen, setIsOpen }) {
    ...
    <>
      <ExpandedDrawer isOpen={isOpen} onClose={setIsOpen}>
        ...
        <div className='bg-[#f5f7fa] min-h-screen  p-10'>
          <h4 className='header_h3 text-2xl'>Contact Information</h4>
