...
// import TextForm from '../../formRequest/TextForm'
import AttachmentForm from '../../formRequest/AttarchmentForm'
import TextForm2 from '../../formRequest/TextForm2'

export default function PersonalInformationDrawer({ isOpen, setIsOpen }) {
    ...
    <>
      <ExpandedDrawer isOpen={isOpen} onClose={setIsOpen}>
        ...
        <div className='bg-[#f5f7fa] min-h-screen  p-10'>
          <h4 className='header_h3 text-2xl'>Personal Information</h4>
