...
import TextForm from '../../workForm/TextForm'
import AttachmentForm from '../../workForm/AttarchmentForm'
import NoteForm from '../../workForm/NoteForm'

export default function WorkInformationDrawer({ isOpen, setIsOpen }) {
    ...
    <>
      <ExpandedDrawer isOpen={isOpen} onClose={setIsOpen}>
        ...
        <div className='bg-[#f5f7fa] min-h-screen  p-10'>
          <h4 className='header_h3 text-2xl'>Work Exprirence Information</h4>
