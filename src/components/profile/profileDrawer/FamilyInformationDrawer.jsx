...
import TextForm from '../../familyForm/TextForm'
import AttachmentForm from '../../familyForm/AttarchmentForm'
import NoteForm from '../../familyForm/NoteForm'

export default function FamilyInformationDrawer({ isOpen, setIsOpen }) {
    ...
    <>
      <ExpandedDrawer isOpen={isOpen} onClose={setIsOpen}>
        ...
        <div className='bg-[#f5f7fa] min-h-screen  p-10'>
          <h4 className='header_h3 text-2xl'>Family Information</h4>
