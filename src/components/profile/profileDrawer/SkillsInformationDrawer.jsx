...
import TextForm from '../../skillsForm/TextForm'

export default function SkillsInformationDrawer({ isOpen, setIsOpen }) {
    ...
    <>
      <ExpandedDrawer isOpen={isOpen} onClose={setIsOpen}>
        {/* <div className='flex h-full flex-col md:flex-row overflow-y-scrol'>
          <div className='flex flex-col w-full nd:w-60 bg-chatsidebar'>
        ...
        <div className='bg-[#f5f7fa] min-h-screen  p-10'>
          <h4 className='header_h3 text-2xl'>Skill Information</h4>
