...
import TextForm from '../../nextOfKinForm/TextForm'
import AttachmentForm from '../../nextOfKinForm/AttarchmentForm'
import NoteForm from '../../nextOfKinForm/NoteForm'

export default function NextOfKinDrawer({ isOpen, setIsOpen }) {
    ...
    <>
      <ExpandedDrawer isOpen={isOpen} onClose={setIsOpen}>
        ...
        <div className='bg-[#f5f7fa] min-h-screen  p-10'>
          <h4 className='header_h3 text-2xl'>Next Of Kin Information</h4>
