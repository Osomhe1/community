...
import TextForm from '../../certificationForm/TextForm'
import AttachmentForm from '../../certificationForm/AttarchmentForm'
import NoteForm from '../../certificationForm/NoteForm'

export default function CertInformationDrawer({ isOpen, setIsOpen }) {
    ...
    <>
      <ExpandedDrawer isOpen={isOpen} onClose={setIsOpen}>
        ...
        <div className='bg-[#f5f7fa] min-h-screen  p-10'>
          <h4 className='header_h3 text-2xl'>Certification Information</h4>
