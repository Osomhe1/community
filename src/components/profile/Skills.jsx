...
import SkillsInformationDrawer from './profileDrawer/SkillsInformationDrawer'
...
export default function Skills() {
  ...
  return (
    <>
      <Card title='Skills' onEditClick={handleEditClick} hasEditIcon={true}>
