...
import { boughtCourses, lists, requirements } from "./data";
import Video from "./Video";
import { useRef, useState,useEffect } from "react";

const ViewCourse = ({ selectedCourse }) => {
 ...
 if(playMode){
      ...
      <ul className="">
        {videos.map((video, i) => (
          <li
            ...
            } flex items-center justify-between text-xs leading-[2rem] cursor-pointer hover:bg-slate-100 px-2 rounded flex-wrap`}
            onClick={() => play(video,i)}
          >
  ...
  return (
    <div className="font-poppins bg-white shadow">
       { playMode?  
      <div style={myStyles}>
      <div ref={videoRef}  className=" bg-black bg-opacity-70 px-6">
