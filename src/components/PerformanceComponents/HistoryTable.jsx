...
import { columns, staff, statusColorMap, statusOptions } from "./data";
      ...
      <div className="flex flex-col gap-4 font-medium">
        ...
        <div className="flex justify-between items-center">
          <span className="text-default-400 text-small">
            Total of {staff.length} Performances
          </span>
  ...
  return (
    <Fragment>
      {staff.length > 0 ? (
        ...
        <p className="font-helvetica text-xl">You have no approvals</p>
        </div>
      )}
    </Fragment>
  );
