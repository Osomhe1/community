...
// import ChatTime from "../pages/home/rightMenu/components/ChatTime";
// import TimeAgo from "../pages/home/centerFeed/TimeAgo";
...
const MessageBox = ({ data, isLarge, otherUser }) => {
  ...
  // console.log(isValidTimestamp(parseInt(data?.CHAT_TIME)))
  ...
  // console.log(data?.FILE_NAME?.includes('jpeg'))
  ...
  return (
    <div className={container}>
      <div className={avatar}>
        ...
        otherUser?.FILE_NAME ? (
          <Avatar className="w-5 h-5 rounded-full" src={filePrefix + otherUser?.FILE_NAME} />
        ) : (
          <Avatar
            size="sm"
