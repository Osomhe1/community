      ...
      <section>
        <div className="flex justify-between items-center gap-4">
              <div className="">
                ...
                <div >
                  <span className="text-gray-400 uppercase text-xs flex items-center gap-1 font-helvetica">Self service <IoIosArrowForward className="text-md" /> Next of kin</span>
                </div>
              </div>
