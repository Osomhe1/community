...
const ClosedOrders = ({orders,view,setCurrentInformation}) => {
...
view()
  ...
  return (
   ...
   <div className="flex flex-col md:flex-row gap-4 items-start md:items-center">
    ...
    <p className="inline-block bg-gray-400 text-white px-1 uppercase rounded-sm text-xs">Cancelled - Payment unsuccessful</p>
    <p className="md:text-[16px] font-medium">{order.cancelled_date}</p>
    </div>
   </div>
