...
const TrainingSliderCard = ({ course }) => {
  return (
    <div className=" bg-white rounded-md cursor-pointer w-[300px] font-poppins shadow">
      <div className="h-[12rem] w-[300px]">
        <img
...
export default TrainingSliderCard;
TrainingSliderCard.propTypes = {
