...
const RejectedAuditTable = ({handleOpenDrawer, rows}) => {
  ...
  return (
    ...
    >
      ...
      <TableBody emptyContent={"No Approved Audit found"} items={sortedItems}>
        {(item, index) => (
...
export default RejectedAuditTable;

RejectedAuditTable.propTypes = {
