...
const columns = [
  ...
  {name: "staffNo", uid: "staffNo", sortable: true},
  {name: "dateApproved", uid: "dateApproved", sortable: true},
  {name: "approvedBy", uid: "approvedBy", sortable: true},
...
const Onboard_Await_AuditTable = ({handleOpenDrawer, rows}) => {
      ...
      case "staffNo":
        return (
          <div className="flex flex-col">
            <p className="text-bold text-small max-w-[35vh]">{cellValue}</p>
          </div>
        );
      case "dateApproved":
        return <p className="text-bold text-small max-w-[35vh]">{cellValue}</p>;
...
export default Onboard_Await_AuditTable;

Onboard_Await_AuditTable.propTypes = {
