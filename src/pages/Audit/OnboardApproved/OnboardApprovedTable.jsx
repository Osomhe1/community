...
const columns = [
  ...
  {name: "employment Type", uid: "employmentType", sortable: true},
  {name: "employee No", uid: "employeeNo", sortable: true},
  {name: "hr Approval Date", uid: "hrApprovalDate", sortable: true},
  {name: "onboard Approved By", uid: "onboardApprovedBy", sortable: true},
  {name: "status", uid: "status", sortable: true},
  {name: "audit Approval Date", uid: "auditApprovalDate", sortable: true},
  {name: "audit Approved By", uid: "auditApprovedBy", sortable: true},
  {name: "audit Remark", uid: "auditRemark", sortable: true},
];
...
const OnboardApprovedTable = ({handleOpenDrawer, rows}) => {
  ...
  const renderCell = React.useCallback((user, columnKey) => {
    ...
    switch (columnKey) {
      ...
      case "onboardApprovedBy":
        return <p className="text-bold text-small">{cellValue}</p>;
      
      case "status":
        return  <Chip className="capitalize" color={'success'} size="sm" variant="flat">
        {cellValue}
      </Chip>;
      case "auditApprovalDate":
        return <p className="text-bold text-small">{cellValue}</p>;
      case "auditApprovedBy":
        return <p className="text-bold text-small">{cellValue}</p>;
      case "auditRemark":
        return <p className="text-bold text-small">{cellValue}</p>;
...
export default OnboardApprovedTable;

OnboardApprovedTable.propTypes = {
