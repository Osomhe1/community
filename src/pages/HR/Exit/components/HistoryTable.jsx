...
const HistoryTable = ({ view, setCurrentViewedExitDetails,}) => {
      ...
      case "actions":
        return (
            ...
            <Dropdown>
              ...
              <DropdownMenu>
                <DropdownItem className={`${data.status!='pending'&&'hidden'}`}>Approve</DropdownItem>
                <DropdownItem className={`${data.status!='pending'&&'hidden'}`}>Reject</DropdownItem>
                <DropdownItem onClick={() => viewDetails(data)}>View</DropdownItem>
              </DropdownMenu>
            </Dropdown>
          </div>
        );
