...
import { statusOptions } from "../../Settings/components/data";
...
const TeamMappingTable = ({handleOpenDrawer, rows}) => {
...
export default TeamMappingTable;

TeamMappingTable.propTypes = {
