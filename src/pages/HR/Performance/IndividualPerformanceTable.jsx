...
const columns = [
  ...
  {name: "best Period", uid: "bestPeriod"},
  {name: "Worst period", uid: "worstPeriod"},
  {name: "cummulative", uid: "cummulative"},
];
...
const IndividualPerformanceTable = ({handleOpenDrawer, rows}) => {
  ...
  const renderCell = React.useCallback((user, columnKey) => {
    ...
    switch (columnKey) {
      ...
      case "worstPeriod":
        return <p className="text-bold">{cellValue}</p>;
      case "cummulative":
        return <p className="text-bold text-center">{cellValue}</p>;
  ...
  return (
    ...
    >
      ...
      <TableBody emptyContent={"No Record yet"} items={sortedItems}>
        {(item, index) => (
...
IndividualPerformanceTable.propTypes = {
