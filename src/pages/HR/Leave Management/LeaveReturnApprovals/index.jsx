...
import LeaveReturnApprovalTable from "./LeaveReturnApprovalTable";
import ExpandedDrawerWithButton from "../../../../components/modals/ExpandedDrawerWithButton";
import FormDrawer from "../../../../components/payroll_components/FormDrawer";
export default function LeaveReturnApproval() {
  const data = [
    {
      _id: 1,
  ...
  return (
    <>
      ...
      <PageHeader header_text={'Leave Return Requests Awaiting Approvals'} btnAvailable = {false}/>
         ...
         <section>
         <Separator separator_text={'Leave Return Request'}/>

          <LeaveReturnApprovalTable rows={data} handleOpenDrawer={handleOpenDrawer}/>
        </section>
      </section>
