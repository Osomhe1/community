...
const columns = [
  ...
  {name: "leave Return Date", uid: "leaveReturnDate", sortable: true},
...
const LeaveRequestTable = ({handleOpenDrawer, rows}) => {
  ...
  const renderCell = React.useCallback((user, columnKey) => {
    ...
    switch (columnKey) {
      ...
      case "leaveReturnDate":
        return <p className="text-bold text-small">{cellValue}</p>;
      case "status":
        return  <Chip className="capitalize" color={'warning'} size="sm" variant="flat">
        Pending
      </Chip>;
      case "actions":
