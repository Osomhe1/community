...
const columns = [
  ...
  {name: "overshoot Days", uid: "overshootDays", sortable: true},
...
const LeaveReturnRequestTable = ({handleOpenDrawer, rows}) => {
  ...
  const renderCell = React.useCallback((user, columnKey) => {
    ...
    switch (columnKey) {
      ...
      case "resumptionDate":
        return <p className="text-bold text-small">{cellValue}</p>;
     case "status":
        return <Chip className="capitalize" color={cellValue==='Completed'?'success': cellValue==='Pending'&&'warning'} size="sm" variant="flat">
        {cellValue}
      </Chip>;
      case "actions":
...
export default LeaveReturnRequestTable;

LeaveReturnRequestTable.propTypes = {
