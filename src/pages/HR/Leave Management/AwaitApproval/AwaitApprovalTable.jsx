...
const columns = [
  ...
  {name: "last leave Return Date", uid: "leaveReturnDate", sortable: true},
  {name: "currentApproval", uid: "currentApproval", sortable: true},
...
const AwaitApprovalTable = ({handleOpenDrawer, rows}) => {
...
export default AwaitApprovalTable;

AwaitApprovalTable.propTypes = {
