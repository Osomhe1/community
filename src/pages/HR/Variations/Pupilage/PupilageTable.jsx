...
const columns = [
  ...
  { name: "first Appointment", uid: "firstAppointment", sortable: true },
  { name: "current Appointment", uid: "currentAppointment", sortable: true },
...
const PupilageTable = ({ handleOpenDrawer, rows }) => {
  ...
  const renderCell = React.useCallback((user, columnKey) => {
    ...
    switch (columnKey) {
      ...
      case "directorate":
        return <p className="text-bold text-small w-[30vh]">{cellValue}</p>;
      case "department":
        return <p className="text-bold text-small w-[30vh]">{cellValue}</p>;
...
export default PupilageTable;

PupilageTable.propTypes = {
