...
import AuditPendingVariationTable from "./AuditPendingVariationTable";
import ExpandedDrawerWithButton from "../../../../components/modals/ExpandedDrawerWithButton";
import FormDrawer from "../../../../components/payroll_components/FormDrawer";
export default function AuditPendingVariation() {
  const data = [
    {
      _id: 1,
      name: "ANNUAL",
  ...
  return (
    <>
      <section className="">
      <PageHeader header_text={'Audit Pending Variations'} btnAvailable = {false}/>
        

         <section>
         <Separator separator_text={'Variations'}/>

          <AuditPendingVariationTable rows={data} handleOpenDrawer={handleOpenDrawer}/>
        </section>
      </section>
