...
import { trainingHistory } from "./data.js"
  ...
  <div
            ...
            >
              <div className="flex gap-2 items-center">
                <div
                  className={`rounded-full ${training?.b_color} w-[50px] h-[50px] flex justify-center items-center`}
                >
                  <training.icon
                    size={25}
                    className={`!font-bold ${training.t_color}`}
                  />
                </div>
