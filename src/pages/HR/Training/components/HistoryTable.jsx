    ...
    if (hasSearchFilter) {
      filteredTrainings = filteredTrainings.filter(
        (training) =>
          ...
          training.directorate.toLowerCase().includes(filterValue.toLowerCase()) ||
          training.fee.toLowerCase().includes(filterValue.toLowerCase())
      );
    }
    if (
      statusFilter !== "all" &&
        ...
        return (
          <div className="text-center">
            <Dropdown>
              ...
              <DropdownMenu>
                {/* <DropdownItem onClick={() => viewTraining(training)}>View</DropdownItem> */}
    ...
    return (
      <div className="flex flex-col gap-4 font-medium">
        <Input
          ...
          placeholder="Filter by type, creator, directorate and fee"
