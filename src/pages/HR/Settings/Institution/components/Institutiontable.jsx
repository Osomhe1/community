...
import { columns, institutions, statusOptions } from './data'
...
const Institutiontable = () => {
  ...
  const filteredItems = React.useMemo(() => {
    let filteredUsers = [...institutions]
    ...
    return (
        ...
        <div className="flex flex-col gap-4">
                <div className='flex flex-wrap justify-between gap-4'>
                    ...
                    <span className="text-default-400 text-small">Total {institutions.length} institutions</span>
  ...
  return (
    <>
      ...
      >
        ...
        <Drawer isOpen={isDrawerOpen} onClose={()=>setIsDrawerOpen(false)} isCreate={isCreate} />
