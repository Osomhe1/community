...
const columns = [
  ...
  {name: "Abbrev", uid: "abbrev", sortable: true},
  {name: "Regular", uid: "regular", sortable: true},
  {name: "contribution", uid: "contribution", sortable: true},
  {name: "Type", uid: "type", sortable: true},
  {name: "calculation", uid: "calculation", sortable: true},
...
const AttributeTable = ({handleOpenDrawer, rows}) => {
      ...
      case "actions":
        return (
          <div className="relative flex justify-en items-center gap-2">
                  ...
                  <Button className="bg-[#00bcc2] w-full text-white" 
                  onClick={()=>handleOpenDrawer({attribute, role: "edit"})}
                  >
                    Edit
                  </Button>
          </div>
