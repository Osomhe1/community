...
const columns = [
  ...
  {name: "previous Bank", uid: "previousBank", sortable: true},
  {name: "current Bank", uid: "currentBank", sortable: true},
...
const ChangeBankTable = ({handleOpenDrawer, rows}) => {
