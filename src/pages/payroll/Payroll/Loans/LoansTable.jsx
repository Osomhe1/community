...
const columns = [
  ...
  {name: "loan", uid: "loan", sortable: true},
  ...
  {name: "duration Paid", uid: "durationPaid", sortable: true},
  {name: "duration Left", uid: "durationLeft", sortable: true},
...
const LoansTable = ({handleOpenDrawer, rows}) => {
