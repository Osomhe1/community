...
const columns = [
  ...
  {name: "Exit Year", uid: "exitYear", sortable: true},
...
const SuspensionListTable = ({handleOpenDrawer, rows}) => {
...
export default SuspensionListTable;

SuspensionListTable.propTypes = {
