...
const statusOptions = [
  {name: "Completed", uid: "active"},
  {name: "Hold", uid: "hold"},
  {name: "Not Completed", uid: "notActive"},
];
...
const columns = [
  ...
  {name: "Trainer", uid: "trainer", sortable: true},
  {name: "venue", uid: "venue", sortable: true},
  {name: "status", uid: "status", sortable: true},
  {name: "start Date", uid: "startDate", sortable: true},
  {name: "period In Day", uid: "periodInDay", sortable: true},
...
const CompanySponsoredTrainingTable = ({handleOpenDrawer, rows}) => {
  ...
  const renderCell = React.useCallback((user, columnKey) => {
    ...
    switch (columnKey) {
      ...
      case "venue":
        return <p className="text-bold text-small max-w-[30vh]">{cellValue}</p>;
      case "status":
        return  <Chip className="capitalize" color={
            cellValue==='complete'?statusColorMap['active']: cellValue==='hold'?statusColorMap['hold']: cellValue==='Not Completed'&& statusColorMap.notActive
...
export default CompanySponsoredTrainingTable;

CompanySponsoredTrainingTable.propTypes = {
