...
const columns = [
  ...
  {name: "ref. No", uid: "refNo", sortable: true},
...
const ApprovedTrainingTable = ({handleOpenDrawer, rows}) => {
...
export default ApprovedTrainingTable;

ApprovedTrainingTable.propTypes = {
