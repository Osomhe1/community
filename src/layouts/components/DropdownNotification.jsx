    ...
    <div className="relative text-gray-600">
      ...
      >
        ...
        <BsBellFill color='grey'
                     size={21} className='font-medium text-gray-100' />
      <div className=' absolute h-3 w-5 rounded-full bg-btnColor flex items-center justify-center -right-2 top-[0.4rem] border border-gray-100'>
        <span className='flex items-center justify-center text-[0.57rem] font-bold text-white'>2</span>
      </div>
        </div>
